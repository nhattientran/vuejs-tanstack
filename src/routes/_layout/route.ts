import { createFileRoute, Outlet, Link } from "@tanstack/vue-router";
...
const AppLayout: FunctionalComponent = () => {
  ...
  return h("div", { class: "h-screen overflow-hidden bg-background flex" }, [
    // Sidebar
    h(
      "aside",
      {
      ...
      [
          ...
          navigation.value.map((item) =>
            h(
              Link,
              {
                ...
                to: item.to,
                class:
                  "flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-standard text-muted-foreground hover:bg-accent hover:text-accent-foreground",
                activeProps: {
                  class: "bg-primary/10 text-primary",
                },
              },
              () => [
                h(item.icon, { class: "w-5 h-5 flex-shrink-0" }),
                item.name,
              ],
            ),
          ),
        ...
        // User Profile
        h("div", { class: "border-t border-border p-4" }, [
          h("div", { class: "flex items-center gap-3" }, [
            h(
              "div",
              {
                class:
                  "w-10 h-10 rounded-full bg-primary flex items-center justify-center text-primary-foreground font-medium",
              },
              user.avatar,
            ),
            ...
            h(
              ...
              {
                class:
                  "p-2 text-muted-foreground hover:text-foreground transition-standard",
              },
    ...
    h(
      ...
      [
        ...
        h(
          ...
          {
            class:
              "h-16 bg-card border-b border-border flex items-center justify-between px-4 sm:px-6 lg:px-8",
          },
          [
            h("div", { class: "flex items-center gap-4" }, [
              h(
                ...
                {
                  class:
                    "p-2 text-muted-foreground hover:text-foreground transition-standard touch-target",
              ...
              h(
                ...
                {
                  class:
                    "hidden sm:flex items-center gap-2 bg-muted rounded-lg px-3 py-2",
                },
                [
                  ...
                  h("input", {
                    ...
                    class:
                      "bg-transparent border-none outline-none text-sm text-foreground placeholder:text-muted-foreground w-64",
                  }),
                ],
              ),
            ]),
            h("div", { class: "flex items-center gap-4" }, [
              ...
              h(
                ...
                {
                  class:
                    "relative p-2 text-muted-foreground hover:text-foreground transition-standard touch-target",
                },
                [
                  h(Bell, { class: "w-5 h-5" }),
                  h("span", {
                    class: "absolute top-1 right-1 w-2 h-2 bg-cta rounded-full",
                  }),
                ],
              ),
              // Theme Toggle
              ...
              // Language Switcher
              h("div", { class: "hidden sm:flex items-center gap-2" }, [
                h(
                  "button",
                  {
                    class: [
